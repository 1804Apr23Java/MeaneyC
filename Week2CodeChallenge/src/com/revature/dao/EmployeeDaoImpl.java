...
public class EmployeeDaoImpl implements EmployeeDao {
	...
	public void printAvgSalary() {
		...
		try {
			...
			String sql = "select department_name, avg(salary) as Avg from department inner join employee on department.department_id = employee.department_id group by department_name";
