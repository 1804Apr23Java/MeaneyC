...
public class submitReimbursement extends HttpServlet {
	...
	//	re.employeeId = 5;
		...
		//String json = "{ \"employeeId\" : 1, \"imageLocation\" : \"www.fun.com\", \"state\" : 1, \"resolvingManager\" : 1 }";
		Reimbursement re = om.readValue(json, Reimbursement.class);	
		System.out.println("re employee id is " +re.employeeId);
	...
	//	re.employeeId = 5;
		...
		int json = Integer.parseInt(request.getParameter("employeeId"));
		...
		try {
			json = new JSONObject(request.getInputStream().toString());
		...
		//System.out.println("Json 1: "+json+ " Json2: "+json2+" json3: "+json3+" json4:"+json4);
		//System.out.println();
